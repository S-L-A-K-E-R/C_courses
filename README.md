...
A collection of **C programming and algorithmics resources** intended primarily as a **backup knowledge base for students**.

The repository is currently focused on reference material, exercises, previous course documents, and revision resources. It is not yet organized as a complete standalone course.
